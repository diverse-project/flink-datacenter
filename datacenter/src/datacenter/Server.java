 ...
 * </p>
 * <ul>
 *   <li>{@link datacenter.Server#getLocation <em>Location</em>}</li>
 *   <li>{@link datacenter.Server#getHostedMachines <em>Hosted Machines</em>}</li>
 *   <li>{@link datacenter.Server#getNetwork <em>Network</em>}</li>
 *   <li>{@link datacenter.Server#getTotalCores <em>Total Cores</em>}</li>
 *   <li>{@link datacenter.Server#getTotalMemory <em>Total Memory</em>}</li>
 *   <li>{@link datacenter.Server#getTotalDisk <em>Total Disk</em>}</li>
 *   <li>{@link datacenter.Server#getRemainingMemory <em>Remaining Memory</em>}</li>
 *   <li>{@link datacenter.Server#getRemainingCores <em>Remaining Cores</em>}</li>
 *   <li>{@link datacenter.Server#getRemainingDisk <em>Remaining Disk</em>}</li>
 * </ul>
 *
 * @see datacenter.DatacenterPackage#getServer()
...
public interface Server extends DynamicElement {
	 ...
	 * @see datacenter.DatacenterPackage#getServer_Location()
	...
	/**
	 * Sets the value of the '{@link datacenter.Server#getLocation <em>Location</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link datacenter.Machine}.
	 * It is bidirectional and its opposite is '{@link datacenter.Machine#getServer <em>Server</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see datacenter.DatacenterPackage#getServer_HostedMachines()
	 ...
	 * It is bidirectional and its opposite is '{@link datacenter.CloudNetwork#getServers <em>Servers</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see datacenter.DatacenterPackage#getServer_Network()
	...
	/**
	 * Sets the value of the '{@link datacenter.Server#getNetwork <em>Network</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see datacenter.DatacenterPackage#getServer_TotalCores()
	 * @model required="true"
	 * @generated
	 */
	int getTotalCores();
	...
	/**
	 * Sets the value of the '{@link datacenter.Server#getTotalCores <em>Total Cores</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see datacenter.DatacenterPackage#getServer_TotalMemory()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link datacenter.Server#getTotalMemory <em>Total Memory</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see datacenter.DatacenterPackage#getServer_TotalDisk()
	 * @model required="true"
	 * @generated
	 */
	float getTotalDisk();
	...
	/**
	 * Sets the value of the '{@link datacenter.Server#getTotalDisk <em>Total Disk</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see datacenter.DatacenterPackage#getServer_RemainingMemory()
	...
	/**
	 * Sets the value of the '{@link datacenter.Server#getRemainingMemory <em>Remaining Memory</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see datacenter.DatacenterPackage#getServer_RemainingCores()
	 * @model required="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link datacenter.Server#getRemainingCores <em>Remaining Cores</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see datacenter.DatacenterPackage#getServer_RemainingDisk()
	 * @model required="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link datacenter.Server#getRemainingDisk <em>Remaining Disk</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

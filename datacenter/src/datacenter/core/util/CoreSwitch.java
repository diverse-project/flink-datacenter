...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorePackage.CLOUD_NETWORK: {
				CloudNetwork cloudNetwork = (CloudNetwork)theEObject;
				T result = caseCloudNetwork(cloudNetwork);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.SERVER: {
				...
				if (result == null) result = caseDynamicElement(server);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.MACHINE: {
				...
				if (result == null) result = caseDynamicElement(machine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.JOB: {
				...
				if (result == null) result = caseDynamicElement(job);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.TASK: {
				...
				if (result == null) result = caseDynamicElement(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cloud Network</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cloud Network</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCloudNetwork(CloudNetwork object) {
		return null;
	}

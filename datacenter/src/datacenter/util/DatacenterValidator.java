 ...
 * @generated
 */
public class DatacenterValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final DatacenterValidator INSTANCE = new DatacenterValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "datacenter";
	...
	public boolean validateServer_CPUavailabilityCheck(Server server, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(DatacenterPackage.Literals.SERVER,
				 server,
				 diagnostics,
				 context,
	...
	public boolean validateGeoLocation_latitudeCheck(GeoLocation geoLocation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(DatacenterPackage.Literals.GEO_LOCATION,
				 geoLocation,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",

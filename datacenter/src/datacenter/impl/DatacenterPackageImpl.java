...
import datacenter.Status;
import datacenter.Task;

import datacenter.util.DatacenterValidator;
 ...
 * @generated
 */
public class DatacenterPackageImpl extends EPackageImpl implements DatacenterPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see datacenter.DatacenterPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DatacenterPackageImpl() {
		super(eNS_URI, DatacenterFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link DatacenterPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DatacenterPackage init() {
		if (isInited) return (DatacenterPackage)EPackage.Registry.INSTANCE.getEPackage(DatacenterPackage.eNS_URI);

		// Obtain or create and register package
		DatacenterPackageImpl theDatacenterPackage = (DatacenterPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DatacenterPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DatacenterPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theDatacenterPackage.createPackageContents();

		// Initialize created meta-data
		theDatacenterPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theDatacenterPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return DatacenterValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theDatacenterPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DatacenterPackage.eNS_URI, theDatacenterPackage);
		return theDatacenterPackage;
	}
	...
	public DatacenterFactory getDatacenterFactory() {
		return (DatacenterFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDynamicElement_Timestamp(), this.getTimeStamp(), "timestamp", null, 1, 1, DynamicElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTask_Status(), ecorePackage.getEInt(), "status", null, 1, 1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(statusEEnum, Status.SUCCEDED);
		addEEnumLiteral(statusEEnum, Status.IN_PROGRESS);
		addEEnumLiteral(statusEEnum, Status.ABORTED);
